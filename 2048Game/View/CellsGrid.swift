...
//                let curX: CGFloat = CGFloat(cell.column - 1) * (cellSize + spacing) + spacing
//                let curY: CGFloat = CGFloat(cell.row - 1) * (cellSize + spacing) + spacing
...
//                    with: .color(Color("CellBackColor")))
////                if cell.number > 0 {
////                    context.fill(
////                        Path(roundedRect: cellRect, cornerRadius: 5),
